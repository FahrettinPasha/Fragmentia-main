...
# ── THE GUTTER: Bölüm 1 ve 2 → gutter_runner.py ile çalışır ──────────────
EASY_MODE_LEVELS[1]["type"] = "gutter_runner"
EASY_MODE_LEVELS[2] = {
    "name": "HURDA MEZARLIĞI",
    "goal_score": 2000,
    "theme_index": 2,
    "speed_mult": 1.0,
    "desc": "Hurda mezarlığında geçen ikinci bölüm. Mini boss: Tepe Bekçisi.",
    "music_file": "ara1.mp3",
    "type": "gutter_runner",
}
